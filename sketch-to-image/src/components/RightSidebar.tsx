...
import SketchToImagePanel from './panels/SketchToImagePanel';
...
const RightSidebar: React.FC<RightSidebarProps> = ({
  ...
  const canGenerateDisabled = !(sketchMode && sketchStyle && aspectRatio && resolution && !isGenerating);
      ...
      `}>
        ...
        `}>
          <SketchToImagePanel
            ...
            canGenerateDisabled={canGenerateDisabled}
